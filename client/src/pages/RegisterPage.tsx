...
export function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-background px-4 py-8 relative overflow-y-auto">
        {/* Theme toggle */}
          ...
          <Card className="border-0 shadow-xl">
            <CardContent className="p-8">
              <div className="mb-6">
                ...
                <p className="text-foreground-muted mt-1">Fill in your details to get started</p>
              </div>
              <RegisterForm />
            </CardContent>
          </Card>
